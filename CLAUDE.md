...
choosing different channels) before opening v0.36.0, so neither is re-derived from scratch.

Next, in order: **`spec/0.36.0.md`** — what the loop costs — makes the two largest review-loop costs
