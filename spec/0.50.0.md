...
to record it as `PASS` — both of which destroy the record. That is the make-findings-disappear
pressure this project already names as a hazard, and here the tool is the thing creating it.
