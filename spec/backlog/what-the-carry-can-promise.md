...
| 7 | §4 item 1 | after round N is recorded under the fence, round N−1's own file is byte-identical to what it was before | have the carry normalise round N−1's rows in place so the counts agree — the repair Non-Goal 1 forbids, and every coverage assertion above still passes under it |
