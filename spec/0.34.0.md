...
The check is deliberately **not** registered. It was, for seven rounds, and the registration bought
nothing: it ran where the artifact does not yet exist, while suppressing an entire finding class for
every reviewer. That is the general lesson, not a detail of this release — a mechanical check earns
its registration only in the phase where the thing it measures exists.
