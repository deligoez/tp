...
- `TestFilterFiles_DropFirstBackfill`: 12-file diff whose first 10 alphabetical entries include 3 fixtures yields a 10-entry maintainability list (drops filter before caps)
