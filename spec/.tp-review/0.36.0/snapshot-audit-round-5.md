...
payload, so the review row moves with the round. The audit row does not — that panel is four at
every round. An earlier draft gave the review figure with no round attached, repeating at small
