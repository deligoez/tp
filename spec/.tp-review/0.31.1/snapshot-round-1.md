...
4. The gofmt gate change (§2.1) is a repo lint-config change with no Go unit test; it is verified by `golangci-lint run` reporting a deliberately gofmt-dirty fixture, and guarded going forward by the gate itself.
