...
what `grep -cE '^\| [0-9]+ \|.*\.go:[0-9]' spec/1.49.0.md` prints, against
`grep -cE '^\| [0-9]+ \|' spec/1.49.0.md` for the denominator, and the bare-`from` figure is
`grep -cE '^\| [0-9]+ \| §[0-9.]+ \|' spec/1.49.0.md`.
