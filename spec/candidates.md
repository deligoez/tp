...
|---|---|
| **the ten findings carried out of v1.0.0's audit** | deleted — each was verified present in the release that took it before its entry was removed. They are, by today's names, `spec/backlog/checklist-covers-what-changed.md`, `spec/backlog/refusals-that-name-nothing.md` — split on 2026-09-08 into itself plus `spec/backlog/the-guard-pins-the-whole-listing.md`, `spec/backlog/guards-read-what-production-reads.md` (which took both guard specs), `spec/backlog/an-unreadable-file-is-named.md`, `spec/backlog/an-invalid-task-file-is-reported.md` and `spec/backlog/context-is-cut-on-a-rune-boundary.md`, whose forwarding table maps every moved section — `spec/backlog/ground-command-friction.md` and `spec/backlog/what-the-carry-can-promise.md` |
