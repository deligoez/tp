...
func TestCountAuditFindings_RejectsCategoryOutsideTheEnum(t *testing.T) {
...
`)
	...
	_, err := countAuditFindings("r.ndjson", data)
...
func TestCountAuditFindings_AcceptsTheEnumAndAbsentCategory(t *testing.T) {
...
`)
	...
	findings, err := countAuditFindings("r.ndjson", data)
